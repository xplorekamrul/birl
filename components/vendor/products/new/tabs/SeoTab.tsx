      ...
      <div className="space-y-6">
               ...
               <FormField
                  ...
                  render={({ field }) => (
                     <FormItem>
                        ...
                        <FormControl>
                           <Textarea placeholder="Brief description for search results" {...field} value={field.value || ""} />
                        </FormControl>
                        <FormDescription>150-160 characters recommended</FormDescription>
                        <FormMessage />
                     </FormItem>
                  )}
               />
         ...
         <Card>
            <CardHeader>
               ...
               <CardDescription>Customize how your product appears on social media</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
               <FormField
                  control={control}
